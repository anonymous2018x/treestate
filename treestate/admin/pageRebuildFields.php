	...
	*/
	...
	$schema = array(   
		'products' => array(   
			...
			'cost' => array('appgini' => 'INT not null '),
			'weight' => array('appgini' => 'VARCHAR(40) not null '),
			'quantity' => array('appgini' => 'VARCHAR(40) not null '),
			'category' => array('appgini' => 'VARCHAR(40) not null '),
			'brand' => array('appgini' => 'VARCHAR(40) not null '),
			'status' => array('appgini' => 'VARCHAR(40) not null '),
			'ico' => array('appgini' => 'VARCHAR(40)'),
			'serial' => array('appgini' => 'VARCHAR(40) not null ')
		),
		'locations' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'town' => array('appgini' => 'VARCHAR(40) not null '),
			'estate' => array('appgini' => 'VARCHAR(40) not null '),
			'point' => array('appgini' => 'VARCHAR(40) not null ')
		),
		'patners' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			...
			'product' => array('appgini' => 'VARCHAR(40) not null default \'Unknown\' '),
			'brand' => array('appgini' => 'VARCHAR(40) not null default \'Unknown\' '),
			'filed' => array('appgini' => 'DATETIME '),
			'last_modified' => array('appgini' => 'DATETIME ')
		),
		'orders' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'product' => array('appgini' => 'VARCHAR(40) not null '),
			'client' => array('appgini' => 'VARCHAR(40) not null '),
			'mobile' => array('appgini' => 'VARCHAR(40) not null '),
			'brand' => array('appgini' => 'VARCHAR(40) not null '),
			'quantity' => array('appgini' => 'VARCHAR(40) not null '),
			'amount' => array('appgini' => 'VARCHAR(40) not null '),
			'price' => array('appgini' => 'VARCHAR(40) not null '),
			'town' => array('appgini' => 'VARCHAR(40) not null '),
			'estate' => array('appgini' => 'VARCHAR(40)'),
			'point' => array('appgini' => 'VARCHAR(40)'),
			'status' => array('appgini' => 'VARCHAR(40) not null ')
		)
	);
