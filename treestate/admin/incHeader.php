...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<title>Treestate | <?php echo $Translation['admin area']; ?><?php echo html_attr(isset($GLOBALS['page_title']) ? " | {$GLOBALS['page_title']}" : ''); ?></title>
	...
	<div class="container theme-bootstrap theme-compact">
		...
		<!-- top navbar -->
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background: #58B368;">
