...
function checkdetailsStudent(){
	...
	if ($group=="students") {
		...
		if ($countcheck==0) {
			# code...
			echo '<div class="alert alert-primary"><strong>Whats up '.$name.', Welcome to Treestate- Everything to suit you<a href="student_details_view.php">HERE</a> to get started</strong></div>';
		}
	}
}
