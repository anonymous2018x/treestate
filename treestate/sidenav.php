...
switch ($usergroup) {
  ...
  default:
		# code...
  echo '<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Products">
  <a class="nav-link" href="products_view.php">
  ...
  <a class="nav-link" href="locations_view.php">
  ...
  <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Patners">
  <a class="nav-link" href="patners_view.php">
  <i class="fa fa-fw fa-user"></i>
