	...
	if($submit || $test){
		...
		if($save_result !== true){
			...
			?>
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
						<p style="background-color: white; padding: 20px; margin-bottom: 40px; border-radius: 4px;"><img src="logo.jpg" style="width: 200px; height: 150px"></p>
